...
## 🛠 Improvements
- [ ] **Refactor Market Data**: Optimize `yfinance` calls to reduce latency.
- [ ] **Database Backup**: Automated backup of `finance.db`.
- [ ] **Wishlist Analysis**: Show price history (3, 6, 12 months) and monthly variation.
